...
const add = async (data) => {
 ...
 const subject = 'Welcome to EuryFox Global Admin Panel';
    const text = `
Hello ${data.name || ''},

Your admin account has been created for EuryFox Global Admin Panel.
...
const verifyLogin = async (email, password) => {
  try {
   ...
   console.log("Decrypted Password : ",decryptPassword);
    ...
    throw new CustomError(error.message || "Login failed", statusCode.INTERNAL_SERVER_ERROR);
  }
};
...
var subject='Password Reset OTP for EuryFox Global Admin Panel';
 var text= `
Hello,

We received a request to reset the password for your EuryFox Global Admin Panel account.
